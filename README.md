...
비기능적 요구사항
1. 트랜잭션
    1. 접수취소된 것은 수리를 진행하지 않아야 한다  Sync 호출 
1. 장애격리
    1. 차량수리(repairProcessing) 기능이 수행되지 않더라도  차량접수(acceptProcessing)은 365일 24시간 받을 수 있어야 한다  Async (event-driven), Eventual Consistency
    
    1. 고객이  차량수리 진행상태를 시스템(프론트엔드)에서 확인할 수 있어야 한다  CQRS
...
http://msaez.io/#/storming/E0iENbRlgeQJvFqeCX3bDonuEN53/mine/8cf95c39323bdd4a40f6adfa4ea652b5/-M5UHawfGxECGvgadAZ_
- AS-IS 조직
